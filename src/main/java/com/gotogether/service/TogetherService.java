...
public class TogetherService {
    ...
    public Page<TogetherResponse> getPageList(Pageable pageable, SearchCondition searchCondition) throws Exception {
        if (searchCondition.getKeyword() != null && !"".equalsIgnoreCase(searchCondition.getKeyword().trim())) {
            return togetherRepository.findByTitleContainsIgnoreCaseOrContentContainsIgnoreCaseOrPurposeContainsIgnoreCaseOrCategoryContainsIgnoreCaseOrInvolveTypeContainsIgnoreCaseOrSkillContainsIgnoreCase(searchCondition.getKeyword(),  searchCondition.getKeyword(), searchCondition.getKeyword(), searchCondition.getKeyword(), searchCondition.getKeyword(), searchCondition.getKeyword(), pageable).map(TogetherResponse::new);
        } else {
